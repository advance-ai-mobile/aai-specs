Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-libraries/AAILivenessModel/4.0.1/AAILivenessModel-V4.0.1.tar.bz2', type: :tbz }
