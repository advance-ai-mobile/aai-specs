...
LivenessProSDK is a liveness detection SDK for iOS of AdvanceAI.
  ...
  s.source           = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-livenessPro-detection/1.3.0-alpha.1/iOS-LivenessPro-SDK-V1.3.0-alpha.1.tar.bz2' }
