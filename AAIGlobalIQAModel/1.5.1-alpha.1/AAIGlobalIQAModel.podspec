Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-libraries/AAIGlobalIQAModel/1.5.1-alpha.1/AAIGlobalIQAModel-V1.5.1-alpha.1.tar.bz2', type: :tbz }
