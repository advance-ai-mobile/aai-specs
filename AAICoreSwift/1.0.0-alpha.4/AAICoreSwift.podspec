...
Pod::Spec.new do |s|
  ...
  # Binary distribution from GitHub Release
  s.source           = { 
    :http => 'https://github.com/advance-ai-mobile/AAICoreSwift/releases/download/1.0.0-alpha.4/AAICoreSwift-V1.0.0-alpha.4.tar.bz2'
  }
