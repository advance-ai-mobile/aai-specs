...
Pod::Spec.new do |s|
  ...
  s.description      = 'Provides third-party libraries (ncnn/json11/encryption/http) and optional engine source compilation. Subspecs: NcnnDynamic/NcnnStatic (ncnn form for customer integration), EngineSource (common+models source for internal debugging).'
  ...
  s.source           = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-libraries/AAICVCommonSDK/1.1.0-alpha.1/AAICVCommonSDK-V1.1.0-alpha.1.tar.bz2', type: :tbz }
