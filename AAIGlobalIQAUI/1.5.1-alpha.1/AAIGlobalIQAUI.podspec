...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.author           = 'advance.ai'
  s.source           = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-global-IQA/1.5.1-alpha.1/iOS-GlobalIQA-UI-V1.5.1-alpha.1.tar.bz2', type: :tbz }
  ...
  s.dependency 'AAIGlobalIQASDK', '1.5.1-alpha.1'
end
