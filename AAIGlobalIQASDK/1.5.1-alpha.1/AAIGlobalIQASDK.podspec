...
Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-global-IQA/1.5.1-alpha.1/iOS-GlobalIQA-SDK-V1.5.1-alpha.1.tar.bz2', type: :tbz }
