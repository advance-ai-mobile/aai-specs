...
Pod::Spec.new do |s|
    ...
    s.source           = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-libraries/AAICore/1.0.2-alpha.1/AAICore-V1.0.2-alpha.1.tar.bz2', :type => :tbz }
