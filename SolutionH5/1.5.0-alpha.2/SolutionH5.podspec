...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-Solution-SDK/1.5.0-alpha.2/iOS-SolutionH5-V1.5.0-alpha.2.tar.bz2' }
  ...
  s.dependency 'AAIDataVisorSDK', '0.1.8-alpha.2'
  s.dependency 'AAICore', '1.0.3-alpha.1'
