...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-Solution-SDK/1.4.5-alpha.2/iOS-SolutionH5-V1.4.5-alpha.2.tar.bz2' }
