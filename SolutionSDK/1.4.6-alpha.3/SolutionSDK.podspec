...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://github.com/advance-ai-mobile/SolutionSDK/releases/download/1.4.6-alpha.3/SolutionSDK-V1.4.6-alpha.3.tar.bz2' }
