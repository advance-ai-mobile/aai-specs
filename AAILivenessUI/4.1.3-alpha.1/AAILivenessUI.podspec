Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-liveness-detection/4.1.3-alpha.1/iOS-Liveness-SDK-V4.1.3-alpha.1.tar.bz2', type: :tbz }
