Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-liveness-UI/4.3.0/iOS-Liveness-UI-V4.3.0.tar.bz2', type: :tbz }
  ...
  s.dependency 'AAILivenessSDK', '~> 4.3.0'
