Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-liveness-UI/4.1.5-alpha.2/iOS-Liveness-UI-V4.1.5-alpha.2.tar.bz2', type: :tbz }
