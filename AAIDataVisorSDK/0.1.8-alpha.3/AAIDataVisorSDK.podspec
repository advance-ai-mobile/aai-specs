...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :http => 'https://prod-guardian-cv.oss-ap-southeast-5.aliyuncs.com/sdk/iOS-AAIDataVisor-SDK/0.1.8-alpha.3/iOS-AAIDataVisorSDK-V0.1.8-alpha.3.tar.bz2' }
